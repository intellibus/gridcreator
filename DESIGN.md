...
- [gridcreator design](#gridcreator-design)
...
`gridcreator` is designed to allow developers to automate creating grids in `bigparser`.

## How is it different from what I already use?

**WORK IN PROGRESS**: `gridcreator` is still in the `design` phase.
...
`gridcreator` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`gridcreator` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
